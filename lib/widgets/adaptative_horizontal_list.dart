      ...
      builder: (context, constraints) {
        return Column(
          children: [
                ...
                if (!widget.isLoading)
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Opacity(
                          opacity: showLeftButton ? 1.0 : 0.0,
                          child: IgnorePointer(
                            ...
                            child: _NavigationButton(
                              ...
                              onPressed: () {
                                ...
                                _pageController.animateToPage(
                                  _currentPage.toInt() - _cardCountOnScreen,
                        ...
                        Opacity(
                          opacity: showRightButton ? 1.0 : 0.0,
                          child: IgnorePointer(
            ...
            if (_cardCountOnScreen == 1 && widget.showPaginationBullets)
              SizedBox(
                height: 16.0,
